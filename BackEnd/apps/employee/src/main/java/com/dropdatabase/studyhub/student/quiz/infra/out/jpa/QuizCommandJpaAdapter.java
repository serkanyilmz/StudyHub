package com.dropdatabase.studyhub.student.quiz.infra.out.jpa;// src/main/java/com.dropdatabase.studyhub.employee.quiz/infra/out/persistence/QuizJpaAdapter.java

import com.dropdatabase.studyhub.student.classroom.infra.out.jpa.ClassroomJpaRepository;
import com.dropdatabase.studyhub.student.question.infra.out.jpa.QuestionJpaRepository;
import com.dropdatabase.studyhub.student.question.infra.out.jpa.entity.QuestionJpaEntity;
import com.dropdatabase.studyhub.student.quiz.application.port.QuizCommandPort;
...
import com.dropdatabase.studyhub.student.quiz.infra.out.jpa.entity.QuizQuestionJpaEntity;
import com.dropdatabase.studyhub.student.topic.infra.out.jpa.TopicJpaRepository;
import com.dropdatabase.studyhub.student.topic.infra.out.jpa.entity.TopicJpaEntity;
import com.dropdatabase.studyhub.student.writer.infra.out.jpa.WriterJpaRepository;
import com.dropdatabase.studyhub.student.writer.infra.out.jpa.entity.WriterJpaEntity;
