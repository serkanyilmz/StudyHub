package com.dropdatabase.studyhub.employee.topic.infra.out.jpa;// src/main/java/com.dropdatabase.studyhub.employee.topic/infra/out/persistence/TopicJpaAdapter.java
...
public class TopicCommandJpaAdapter implements TopicCommandPort {
    ...
    private final com.dropdatabase.studyhub.employee.topic.infra.out.jpa.TopicJpaRepository topicJpaRepository;
