package com.dropdatabase.studyhub.student.question.infra.out.jpa;// src/main/java/com.dropdatabase.studyhub.employee.question/infra/out/persistence/QuestionJpaAdapter.java

import com.dropdatabase.studyhub.student.question.application.port.QuestionCommandPort;
...
public class QuestionCommandJpaAdapter implements QuestionCommandPort {
    ...
    private final com.dropdatabase.studyhub.student.question.infra.out.jpa.QuestionJpaRepository questionJpaRepository;
