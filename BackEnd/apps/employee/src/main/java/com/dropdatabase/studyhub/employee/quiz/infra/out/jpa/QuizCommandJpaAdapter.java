package com.dropdatabase.studyhub.employee.quiz.infra.out.jpa;// src/main/java/com.dropdatabase.studyhub.employee.quiz/infra/out/persistence/QuizJpaAdapter.java
...
public class QuizCommandJpaAdapter implements QuizCommandPort {
    ...
    private final com.dropdatabase.studyhub.employee.quiz.infra.out.jpa.QuizJpaRepository quizJpaRepository;
