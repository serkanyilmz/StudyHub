package com.dropdatabase.studyhub.employee.classroom.infra.out.jpa;// src/main/java/com.dropdatabase.studyhub.employee.classroom/infra/out/persistence/ClassroomJpaAdapter.java

import com.dropdatabase.studyhub.employee.classroom.application.port.ClassroomQueryPort;
...
public class ClassroomQueryJpaAdapter implements ClassroomQueryPort {
    ...
    private final com.dropdatabase.studyhub.employee.classroom.infra.out.jpa.ClassroomJpaRepository classroomJpaRepository;
