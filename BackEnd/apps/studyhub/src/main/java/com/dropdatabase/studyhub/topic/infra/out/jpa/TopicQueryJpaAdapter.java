package com.dropdatabase.studyhub.topic.infra.out.jpa;// src/main/java/com.dropdatabase.studyhub.employee.topic/infra/out/persistence/TopicJpaAdapter.java

import com.dropdatabase.studyhub.topic.application.port.TopicQueryPort;
