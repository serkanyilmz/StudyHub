...
export function WriterDashboard({ activeView }: WriterDashboardProps) {
  ...
  const quizzes = [
    { id: 1, title: "React Fundamentals", questions: 10, category: "Programming", status: "Published", attempts: 45 },
    { id: 2, title: "AI Basics", questions: 15, category: "AI/ML", status: "Draft", attempts: 0 },
    { id: 3, title: "SQL Mastery", questions: 20, category: "Database", status: "Published", attempts: 78 },
  ]
